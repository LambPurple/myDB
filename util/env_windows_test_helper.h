// Copyright 2018 (c) The MyDB Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file. See the AUTHORS file for names of contributors.

#ifndef STORAGE_MYDB_UTIL_ENV_WINDOWS_TEST_HELPER_H_
#define STORAGE_MYDB_UTIL_ENV_WINDOWS_TEST_HELPER_H_
