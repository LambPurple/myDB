...
#ifndef STORAGE_MYDB_UTIL_WINDOWS_LOGGER_H_
#define STORAGE_MYDB_UTIL_WINDOWS_LOGGER_H_
    ...
    void Logv(const char* format, std::va_list arguments) override {
        ...
        for (int iteration = 0; iteration < 2; ++iteration) {
            ...
            int buffer_offset = std::snprintf(
                ...
                now_components.wYear, now_components.wMonth,
                now_components.wDay, now_components.wHour,
...
#endif // STORAGE_MYDB_UTIL_WINDOWS_LOGGER_H_
