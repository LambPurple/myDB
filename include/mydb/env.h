...
// An Env is an interface used by the mydb implementation to access
...
#ifndef STORAGE_MYDB_INCLUDE_ENV_H_
#define STORAGE_MYDB_INCLUDE_ENV_H_
...
#undef DeleteFile
#define MYDB_DELETEFILE_UNDEFINED
...
class MYDB_EXPORT Env {
  public:
    ...
    //
    // The result of Default() belongs to mydb and must never be deleted.
    static Env* Default();
    ...
    // the mydb implementation) must be prepared to deal with
...
class MYDB_EXPORT SequentialFile {
  public:
...
class MYDB_EXPORT RandomAccessFile {
  public:
...
class MYDB_EXPORT WritableFile {
  public:
...
MYDB_EXPORT Status WriteStringToFile(Env* env, const Slice& data,
                                     const std::string& fname);

// A utility routine: read contents of named file into *data
MYDB_EXPORT Status ReadFileToString(Env* env, const std::string& fname,
                                    std::string* data);

// An implementation of Env that forwards all calls to another Env.
// May be useful to clients who wish to override just part of the
// functionality of another Env.
class MYDB_EXPORT EnvWrapper : public Env {
  public:
...
#endif // defined(_WIN32) && defined(MYDB_DELETEFILE_UNDEFINED)

#endif // STORAGE_MYDB_INCLUDE_ENV_H_
