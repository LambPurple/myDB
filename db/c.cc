...
using mydb::Cache;
using mydb::Comparator;
using mydb::CompressionType;
using mydb::DB;
using mydb::Env;
using mydb::FileLock;
using mydb::FilterPolicy;
using mydb::Iterator;
using mydb::kMajorVersion;
using mydb::kMinorVersion;
using mydb::Logger;
using mydb::NewBloomFilterPolicy;
using mydb::NewLRUCache;
using mydb::Options;
using mydb::RandomAccessFile;
using mydb::Range;
using mydb::ReadOptions;
using mydb::SequentialFile;
using mydb::Slice;
using mydb::Snapshot;
using mydb::Status;
using mydb::WritableFile;
using mydb::WriteBatch;
using mydb::WriteOptions;
...
mydb_filterpolicy_t* mydb_filterpolicy_create(
    void* state, void (*destructor)(void*),
...
int mydb_major_version() { return kMajorVersion; }
